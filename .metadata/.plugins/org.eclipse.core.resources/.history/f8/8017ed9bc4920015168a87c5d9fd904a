...
public class BountyPreferenceCenter {
	...
	@Test(groups = {"wrong_login"})
	
	public void testWrongLogin() throws IOException, InterruptedException{
	...
	@Test(groups = {"reset_password_screen"})
	...
	@Test(groups = {"blank_password_set"})
